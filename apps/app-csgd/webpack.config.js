 ...
 */
const tsConfigPath =
  process.env.NX_TSCONFIG_PATH ? process.env.NX_TSCONFIG_PATH : path.join(__dirname, '../../tsconfig.base.json');
...
module.exports = {
  ...
  plugins: [
    new ModuleFederationPlugin({
      ...
      exposes: {
        './Module': 'apps/app-csgd/src/app/remote-entry/entry.module.ts',
      },
      remotes: {

...
module.exports = {
  output: {
    uniqueName: 'features_app_cn_danhsachtruycap',
    publicPath: 'auto',
  },
  optimization: {
    runtimeChunk: false,
  ...
  plugins: [
    new ModuleFederationPlugin({
      name: 'features_app_cn_danhsachtruycap',
      filename: 'remoteEntry.js',
      exposes: {
        './Module':
          'apps/features/app-cn-danhsachtruycap/src/app/remote-entry/entry.module.ts',
      },
      shared: {
